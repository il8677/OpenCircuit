...
void SimulationManager::onImGuiDraw(){
    ...
    m_chunk.getSchematic()->getValidationSet().getTransformer().setInputCount(inputs.size());
    ...
    m_chunk.getSchematic()->getValidationSet().getTransformer().setOutputCount(outputs.size());
